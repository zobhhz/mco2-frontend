                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex flex-row my-4">
                                    ...
                                    <div className="flex flex-col w-1/2">
                                        <label htmlFor="director" className="font-semibold">
                                            Director
                                        </label>
                                        <input
                                            type="text"
                                ...
                                <div className="flex flex-row mb-4">
                                    <div className="flex flex-col w-1/3 mr-4">
                                        <label htmlFor="genre1" className="font-semibold">
                                            Genre 1
                                        </label>
                                        <input
                                            type="text"
                                            value={movie.genre1}
                                            onChange={(e) => setMovie({ ...movie, genre1: e.target.value })}
                                        />
                                    </div>

                                    <div className="flex flex-col w-1/3 mr-4">
                                        <label htmlFor="genre2" className="font-semibold">
                                            Genre 2
                                        </label>
                                        <input
                                            type="text"
                                            value={movie.genre2}
                                            onChange={(e) => setMovie({ ...movie, genre2: e.target.value })}
                                        />
                                    </div>

                                    <div className="flex flex-col w-1/3">
                                        <label htmlFor="genre3" className="font-semibold">
                                            Genre 3
                                        </label>
                                        <input
                                            type="text"
                                            value={movie.genre3}
                                            onChange={(e) => setMovie({ ...movie, genre3: e.target.value })}
                                        />
                                    </div>
                                </div>
                            </div>

                            <Button variant="white" className="mr-4" onClick={() => handleDelete()}>
                                Delete
                            </Button>
